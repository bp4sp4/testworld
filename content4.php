        ...
        <div class="rollingPage_1">
          <div class="profile">
            <div class="people_img">
              <img src="./image/genderImage/M/40대_남자.svg" alt="40대 남자">
            </div>
          ...
          <div class="interest_content_box">
            <ul>
              <li>
                <a href="https://kr.vonvon.me/quiz/19383">
                  <div class="interest_content">
                  <div class="thumbnail-13">부자 운 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 1위</h4>
                        <p>
                         부자 운 테스트 - 나는 어떤 방식으로 부자가 될 운명일까?
                        </p>
                      </div>
              ...
              <li>
                <a href="https://kr.vonvon.me/quiz/19373">
                  <div class="interest_content">
                  <div class="thumbnail-14">악마가알려주는운세</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 2위</h4>
                        <p>
                        악마의 운세 테스트 - 악마가 알려주는 운세
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://kr.vonvon.me/quiz/19347">
                  <div class="interest_content">
                  <div class="thumbnail-15">조선 계급도</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 3위</h4>
                        <p>
                         조선계급도 - 성격으로 알아보는 당신의 조선시대 신분은?
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://egogramtest.kr/">
                  <div class="interest_content">
                  <div class="thumbnail-16">에고그램 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 4위</h4>
                        <p>
                         에고그램 - 성격유형/ 인적성 무료검사테스트
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
