        ...
        <div class="rollingPage_1">
          <div class="profile">
            <div class="people_img">
              <img src="./image/genderImage/W/30대_여자.svg" alt="30대 여자">
            </div>
          ...
          <div class="interest_content_box">
            <ul>
              <li>
                <a href="https://poomang.com/detail/zdayo">
                  <div class="interest_content">
                  <div class="thumbnail-29">방구석 투자 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>30대 심리테스트 1위</h4>
                        <p>
                          방구석 투자 테스트 - 요즘 다들 한다는 주식, 당신은 투자 심리는 어떨까요?
                        </p>
                      </div>
              ...
              <li>
                <a href="https://poomang.com/detail/eaekc">
                  <div class="interest_content">
                  <div class="thumbnail-30">아이스크림 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>30대 심리테스트 2위</h4>
                        <p>
                         아이스크림 테스트 - 내가 아이스크림이 된다면 어떤 아이스크림 일까?
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://poomang.com/detail/qhwun">
                  <div class="interest_content">
                  <div class="thumbnail-31">캌테일 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>30대 심리테스트 3위</h4>
                        <p>
                     칵테일 테스트 - 당신의 연애 스타일을 달콤쌉싸름한 칵테일로 알려줄게요!
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://poomang.com/detail/mscru">
                  <div class="interest_content">
                  <div class="thumbnail-32">웨딩스타일 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>30대 심리테스트 4위</h4>
                        <p>
                          웨딩 스타일 테스트 -  당신의 결혼식 로망은 무엇인가요? 웨딩스타일로 테스트해봐요!
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
