        ...
        <div class="rollingPage_1">
          <div class="profile">
            <div class="people_img">
              <img src="./image/genderImage/W/40대_여자.svg" alt="40대 여자">
            </div>
            <div class="profile_info">
              <div class="info_gender">WOMEN</div>
              <div class="info_age">40<span>s</span></div>
            </div>
          </div>
          <div class="interest_content_box">
            <ul>
              <li>
                <a href="https://poomang.com/detail/leema">
                  <div class="interest_content">
                  <div class="thumbnail-33">별자리 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 1위</h4>
                        <p>
                        별자리 테스트 - 밤하늘에 수많이 놓인 별들중 , 당신의 별을 무엇일까요?
                        </p>
                      </div>
              ...
              <li>
                <a href="https://poomang.com/detail/vflhv">
                  <div class="interest_content">
                  <div class="thumbnail-34">완벽주의 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 2위</h4>
                        <p>
              완벽주의 테스트 - 당신의 완벽주의성향은 몇 퍼센튼이지 궁긍하죠?
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://poomang.com/detail/ckuqn">
                  <div class="interest_content">
                  <div class="thumbnail-35">번아웃 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 3위</h4>
                        <p>
                          번아웃 테스트 - 일을 하며 부쩍 피곤하다고 느끼고 계신가요? 혹시, 번아웃은 아닌가요? 
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://poomang.com/detail/hsxww">
                  <div class="interest_content">
                  <div class="thumbnail-36">나의 이웃 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>40대 심리테스트 4위</h4>
                        <p>
                         나의 이웃 테스트 -  가깝고도 먼 존재 , 그것은 바로 이웃! 당신은 어떤 이웃인가요?
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
