        ...
        <div class="rollingPage_1">
          <div class="profile">
            <div class="people_img">
              <img src="./image/genderImage/M/50대_남자.svg" alt="50대 남자">
            </div>
          ...
          <div class="interest_content_box">
            <ul>
              <li>
                <a href="https://kr.vonvon.me/quiz/3444">
                  <div class="interest_content">
                  <div class="thumbnail-17">연예인 닮은꼴</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>50대 심리테스트 1위</h4>
                        <p>
                          연예인 닮은꼴 - 당신과 가장 닮은 연예인은 누구?!
                        </p>
                      </div>
              ...
              <li>
                <a href="https://poomang.com/detail/vyoyp">
                  <div class="interest_content">
                  <div class="thumbnail-18">행성 찾기</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>50대 심리테스트 2위</h4>
                        <p>
              ...
              <li>
                <a href="https://poomang.com/detail/yovic">
                  <div class="interest_content">
                  <div class="thumbnail-19">채소 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>50대 심리테스트 3위</h4>
                        <p>
                          채소테스트 - 내 성격으로 알아보는 채소 테스트
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://poomang.com/detail/jybqs">
                  <div class="interest_content">
                  <div class="thumbnail-20">꽃 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>50대 심리테스트 4위</h4>
                        <p>
                         꽃테스트 - 내 성격으로 알아보는 꽃 성격 테스트 
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
