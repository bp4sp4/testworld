        ...
        <div class="rollingPage_1">
          <div class="profile">
            <div class="people_img">
              <img src="./image/genderImage/W/20대_여자.svg" alt="20대 여자">
            </div>
          ...
          <div class="interest_content_box">
            <ul>
              <li>
                <a href="https://poomang.com/detail/npyss">
                  <div class="interest_content">
                  <div class="thumbnail-25">어른이날 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>20대 심리테스트 1위</h4>
                        <p>
                          어른이날 테스트 - 어른을 맞아 패션 유행 테스트를 해봐요!
                        </p>
                      </div>
              ...
              <li>
                <a href="https://poomang.com/detail/ilhti">
                  <div class="interest_content">
                  <div class="thumbnail-26">불효자 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>20대 심리테스트 2위</h4>
                        <p>
                       불효자 테스트 - 나는 고연 어떤 종류의 불효자일까?
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://poomang.com/detail/yooih">
                  <div class="interest_content">
                  <div class="thumbnail-27">씀씀이 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>20대 심리테스트 3위</h4>
                        <p>
                          씀씀이테스트 - 간단한 성격테스트로 알아보는 당신의 씀씀이 테스트!
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
              ...
              <li>
                <a href="https://poomang.com/detail/lausp">
                  <div class="interest_content">
                  <div class="thumbnail-28">직장인 부캐 테스트</div>
                    <div class="interest_content_desc">
                      <div class="interest_content_desc_text">
                        <h4>20대 심리테스트 4위</h4>
                        <p>
                         직장인 부캐 - 직장에서 나는 어떤 부캐를 갖고 살고 있을까?
                        </p>
                      </div>
                      <div class="interest_content_desc_func">
                        <button class="star"><img src="./image/icon/별_빈.svg" alt=""></button>
